...
# This is so the s_curve function knows where to begin
L1_init_s = Lengths_and_Moments(x_init,y_init)[0]
L2_init_s = Lengths_and_Moments(x_init,y_init)[1]

L1_end_s = Lengths_and_Moments(x_end,y_end)[0]
L2_end_s = Lengths_and_Moments(x_end,y_end)[1]
...
sys.specifieds={L1:lambda x, t:s_curve(t, L1_init_s, L1_end_s, RiseTime,
                                       StartTime),
                L2:lambda x, t:s_curve(t, L2_init_s, L2_end_s, RiseTime,
                                       StartTime)}
